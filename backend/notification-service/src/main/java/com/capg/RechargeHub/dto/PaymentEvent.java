 ...
 * CLASS   : PaymentEvent (notification-service)
 * DESCRIPTION:
 *   Serializable event object received from RabbitMQ.
 *   Published by the payment-service after a transaction completes.
 *   Used by NotificationListener to build notification messages.
 * ================================================================ */
