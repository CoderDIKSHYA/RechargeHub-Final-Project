 ...
 * CLASS   : RabbitMQConfig (notification-service)
 * DESCRIPTION:
 *   RabbitMQ configuration for the Notification Service.
 *   Declares the queue, topic exchange, and binding to receive
 *   PaymentEvent messages published by the payment-service.
 *   Uses Jackson2JsonMessageConverter for JSON deserialization.
 * ================================================================ */
